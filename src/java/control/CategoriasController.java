...
public class CategoriasController implements Serializable {
    ...
    private List<Categorias> itemseliminados = null;
    private Categorias selected;

    public List<Categorias> getItemseliminados() {
    ...
    public void setItemseliminados(List<Categorias> itemseliminados) {
    ...
    public void destroy() {
        ...
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("CategoriasDeleted"));
        if (!JsfUtil.isValidationFailed()) {
            selected = null;
